...
public class ActivitySplash extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (JsonUtils.isNetworkAvailable(ActivitySplash.this)) {
            new MyTaskDev().execute(Constant.ABOUT_US_URL+"1");
        } else {
    ...
    private void Alerta(String Titulo,String Mensaje) {
        new AlertDialog.Builder(ActivitySplash.this).setTitle(Titulo).setMessage(Mensaje).setCancelable(false).setPositiveButton("OK",null).show();
    }
}